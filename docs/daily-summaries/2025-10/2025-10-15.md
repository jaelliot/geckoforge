# 2025-01-15 — Geckoforge Rclone Backup System & Font Configuration
...
- `profile/config.kiwi.xml` - Added system-level font packages (liberation-fonts, dejavu-fonts, noto-sans-fonts, noto-emoji-fonts, fontconfig)
