# 2025-10-16 — geckoforge Session Summary
...
- `docs/keyboard-configuration.md` - User guide for macOS-style keyboard workflow
- `profile/scripts/firstboot-ssh-hardening.sh` - Production SSH policy for first boot
- `profile/root/etc/systemd/system/geckoforge-ssh-hardening.service` - One-shot service binding
- `profile/root/etc/systemd/system/multi-user.target.wants/geckoforge-ssh-hardening.service` - Activation link for SSH hardening
...
- `docs/security-configuration.md` - Security hardening guide
...
- `docs/night-color.md` - Night Color defaults, customization, and troubleshooting guide
...
- `profile/config.kiwi.xml` - Added SSH hardening script/service to KIWI image
...
- `docs/keyboard-configuration.md`
