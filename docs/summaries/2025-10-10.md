<!-- @file docs/summaries/2025-10-10.md -->
...
- `tools/check-anti-patterns.sh` - Anti-pattern detection (Podman, TeX Live violations, wrong package managers)
- `tools/check-layer-assignments.sh` - Four-layer architecture boundary validation
- `docs/summaries/2025-10-10.md` - This file
...
**Approach**: Create `tools/` directory for reusable validation scripts  
